package com.ehi.designMode.BuilderPattern;

import com.ehi.designMode.BuilderPattern.model.*;
 ...
 * @Author: WangYiHai
 * @Date: 2020/4/8 15:14
 * @Description: 建造者模式（Builder Pattern）使用多个简单的对象一步一步构建成一个复杂的对象。
 ...
 *
 * 我们将创建一个表示食物条目（比如汉堡和冷饮）的 Item 接口和实现 Item 接口的实体类，以及一个表示食物包装的
 * Packing 接口和实现 Packing 接口的实体类，汉堡是包在纸盒中，冷饮是装在瓶子中。
 *
